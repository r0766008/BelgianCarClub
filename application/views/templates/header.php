...
<head>
    ...
    <link href="<?= base_url('assets/css/fullcalendar/core/main.min.css'); ?>" rel='stylesheet' />
    <link href="<?= base_url('assets/css/fullcalendar/daygrid/main.min.css'); ?>" rel='stylesheet' />
        ...
        <nav class="white">
            <div class="nav-wrapper container">
                ...
                <ul class="hide-on-med-and-down left">
                    ...
                    <li><?= anchor(base_url('spotlights'), $this->lang->line('header_spotlights', TRUE)); ?></li>
                    <li><?= anchor(base_url('calendar'), $this->lang->line('header_calendar', TRUE)); ?></li>
                    <!--<li><?= anchor(base_url('shop'), $this->lang->line('header_shop', TRUE)); ?></li>-->
                </ul>
                ...
                <ul id="nav-mobile" class="sidenav">
                    ...
                    <li><?= anchor(base_url('spotlights'), $this->lang->line('header_spotlights', TRUE)); ?></li>
                    <li><?= anchor(base_url('calendar'), $this->lang->line('header_calendar', TRUE)); ?></li>
                    <!--<li><?= anchor(base_url('shop'), $this->lang->line('header_shop', TRUE)); ?></li><br>-->
                    <li><?= anchor(base_url('contact'), $this->lang->line('header_contact', TRUE)); ?></li>
                    <li><?= anchor(base_url($this->ion_auth->logged_in() ? 'logout' : 'login'), $this->ion_auth->logged_in() ? $this->lang->line('header_logout') : $this->lang->line('header_login_register')); ?></li>
